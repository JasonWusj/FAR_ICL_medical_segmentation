...
def main():
    ...
    parser.add_argument("--kind", choices=["utility", "marginal", "correction"], default="utility")
    ...
    if args.command == "report":
        ...
        report(cfg["output"])
        return
    from .pipeline import LEARNED, Pipeline, ranker_kind
